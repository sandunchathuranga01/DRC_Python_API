...
from openApi.routes.RequestIncidentExternalinformationRoute import router as RequestIncidentExternalinformationRoute
...
# Include routes
app.include_router(RequestIncidentExternalinformationRoute)
